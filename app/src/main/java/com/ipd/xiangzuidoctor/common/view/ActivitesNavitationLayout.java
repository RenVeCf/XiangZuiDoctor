...
public class ActivitesNavitationLayout extends RelativeLayout {
    ...
    private void setTitles(Context context, String[] titles, final boolean smoothScroll, int splilinecolor, float splilinewidth, float topoffset, float bottomoffset) {
        ...
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(dip2px(context, splilinewidth), MATCH_PARENT);
    ...
    public void setBgLine(Context context, int height, int color) {
        ...
        LayoutParams layoutParams = new LayoutParams(MATCH_PARENT, height);
        ...
        if (textViews != null) {
            ...
            for (int i = 0; i < length; i++) {
                if (i == position) {
                    ...
                    textViews[i].setBackgroundResource(R.drawable.bg_gradient_bt);
